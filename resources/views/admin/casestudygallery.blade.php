...
<div class="container w-full   mx-auto flex justify-center py-4">
    <form action="{{ route('managecasestudies.addImageToGallery', $casestudy->id) }}" method="POST" enctype="multipart/form-data" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4 rounded-lg ">
        @csrf
