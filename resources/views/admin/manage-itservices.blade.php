...
<div class="p-7 bg-gray-100 h-screen overflow-y-auto rounded-lg font-Robotomedium">
    ...
    @include('components.heading', ['headingText' => 'Manage IT Services Here', 'headingClass' => 'text-2xl font-normal font-Robotomedium text-rose-950 whitespace-nowrap leading-relaxed'])
    ...
    <div class="max-w-6xl w-full   mx-auto p-2 flex justify-center py-10 flex lg:flex-row md:flex-row sm:flex-col flex-col  gap-2 ">
        ...
        <form action="{{ isset($itService) ? route('manageitservices.update', $itService->id) : route('manageitservices.store') }}" method="post" enctype="multipart/form-data" class=" lg:w-1/2 md:w-1/2 w-full bg-white p-4 rounded-lg shadow-lg">
            @csrf
            @if(isset($itService))
            @method('put')
            @else
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700 font-Robotomedium">
                                    <td class="px-4 py-3"><img src="{{ asset('storage/' . $service->image) }}" alt="Image" width="100" class="h-24"></td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$service->name}}</td>
