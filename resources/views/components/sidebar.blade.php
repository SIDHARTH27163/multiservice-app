...
=======
<article class="flex gap-2 drop-shadow-lg  bg-white   my-1">
    <img loading="lazy" src="{{ asset('storage/' . $place->location->image) }}" class="object-contain z-10 shrink-0 aspect-[1.1] w-[94px]" alt="Article preview image" />
...
<<<<<<< HEAD
                <a href="{{ route('touristplaces.filterByCategory', ['text' => str_replace(' ', '-', $category->name)]) }}" class="flex items-center space-x-4 rtl:space-x-reverse">
=======
