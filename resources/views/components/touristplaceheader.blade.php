    ...
    <a href="/" class="flex flex-row hover:shadow-lg hover:rounded-full transform transition hover:scale-110 duration-500 ease-in-out">
      ...
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-1 lg:mt-0  lg:bg-transparent  p-2 lg:p-0 z-20 " id="nav-content">
        ...
        <li class="mr-0">
          ...
          <li class="mr-0">
            <a id="navitem2" class="toggleColour3 hover:bg-slate-900 hover:text-white text-yellow-500 inline-block text-lg hover:shadow-lg hover:rounded-xl  no-underline  transform transition hover:scale-105 duration-500 ease-in-out py-2 px-4 font-bold" href="/categories">Categories</a>
          </li>
          {{-- <li class="mr-0">
            <a id="navitem1" class="toggleColour6 hover:bg-slate-900 hover:text-white text-yellow-500 inline-block text-lg hover:shadow-lg hover:rounded-xl  no-underline  transform transition hover:scale-105 duration-500 ease-in-out py-2 px-4 font-bold" href="/services">Services</a>
          </li> --}}
