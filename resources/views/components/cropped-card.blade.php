...
<article class="flex flex-col ">
    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/8cd2fdb5a5681497fba4d9b1504e62f230404f1dfec15073ee7fe9ad8138c0cb?placeholderIfAbsent=true&apiKey=c81a87a8b87043acac16b0e47d857063" class="object-contain w-full aspect-[1.06]" alt="Blog post featured image" />
    <div class="flex z-10 flex-col  -mt-16 w-full bg-white lg:max-w-[310px] md:max-w-[320px] sm:max-w-[310px]   max-w-full  shadow-[0px_4px_10px_rgba(0,0,0,0.25)]">
        <header class="flex gap-2.5 items-start self-start mt-4 leading-tight lg:text-base md:text-base sm:text-xs text-xs">
          ...
          <h2 class="mt-3 lg:text-3xl md:text-3xl sm:text-base text-base lg:font-bold md:font-bold sm:font-semibold font-normal leading-6 max-md:mx-4  lg:mx-2 md:mx-2 sm:mx-1 mx-0 ">
            {{$title}}
          </h2>
