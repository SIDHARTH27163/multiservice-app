...
<section class=" px-3 ">
    ...
    <div id="cCarousel" class="relative mx-auto px-1">
        ...
        <div id="prev"
            class="arrow absolute top-1/2 left-0 flex items-center justify-center w-11 h-11 rounded-full z-10 text-white bg-[linear-gradient(225deg,#F76680_0%,#57007B_100%)] bg-opacity-70 cursor-pointer">
        ...
        <div id="next"
            class="arrow absolute top-1/2 right-0 flex items-center justify-center w-11 h-11 rounded-full z-10 text-white bg-[linear-gradient(225deg,#F76680_0%,#57007B_100%)] bg-opacity-70 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div id="cCarousel-inner" class="absolute flex gap-3 transition-all duration-300 ease-in-out left-0   py-3">
                ...
                <article class="flex flex-col ml-5  w-96 max-md:ml-0 max-md:w-full cCarousel-item">
                    <div class="flex flex-col grow justify-center  max-md:mt-10">
                        <div class="flex flex-col px-14 py-14 rounded-lg shadow-lg bg-neutral-50 max-md:px-5">
                            <img loading="lazy"
                            ...
                            <p class="mt-5 text-sm leading-6 text-slate-600 font-playwrite text-justify">
